...
---
## 🔥 News
* **`2024.09.06`** 🌟Since our paper has not been accepted yet, we are temporarily releasing the dataset 
(*`CTIs: the largest dataset on Asians to date on choroid neoplasm imaging `*) on Google Drive. 
